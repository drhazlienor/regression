...
```{r}
#install.packages(setdiff(c("tidyverse", "broom", "haven", "gtsummary", "corrplot",  "mfp", "LogisticDx", "car", "lattice", "caret", "generalhoslem"), rownames(installed.packages())))
```
...
library(LogisticDx) #Diagnostic tools for logistic regression
...
lets examine the ROC, osius rojek, hosmer lemeshow, modified HL, Stukel test
